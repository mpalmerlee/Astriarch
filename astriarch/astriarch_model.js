 ...
 * @constructor
 */
Astriarch.Model = function(/*List<Player>*/ players, /*Player*/ mainPlayer, /*int*/ systemsToGenerate, /*PlanetsPerSystemOption*/ planetsPerSystem, dontPopulatePlanets) {

	/* Since we add our grid from here,
		and it depends on the playfield layer being cleared,
		we'll make sure our view is clean before that,
	...
	this.MainPlayer = mainPlayer;//for now the local human player, this may have to change for multi-player
