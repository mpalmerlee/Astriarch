Astriarch.SendShipsControl = {
	...
	show: function(/*Planet*/ pSource, /*Planet*/ pDest, /*int*/ distance) {
	...
	OKClose: function()	{
		...
		if (scouts != 0 || destroyers != 0 || cruisers != 0 || battleships != 0)
		{
			...
			self.CreatedFleet.CreateDrawnFleetAndSetDestination(self.pSource.BoundingHex, self.pDest.BoundingHex, true);
