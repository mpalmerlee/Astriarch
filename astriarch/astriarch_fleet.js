 ...
 * @this {Astriarch.Fleet}
 */
Astriarch.Fleet.prototype.SetDestination = function(/*Hexagon*/ travelingFromHex, /*Hexagon*/ destinationHex) {
	this.CreateDrawnFleetAndSetDestination(travelingFromHex, destinationHex, Astriarch.GameModel.ShowUnexploredPlanetsAndEnemyPlayerStats);//false);
};
 ...
 * @this {Astriarch.Fleet}
 */
Astriarch.Fleet.prototype.CreateDrawnFleetAndSetDestination = function(/*Hexagon*/ travelingFromHex, /*Hexagon*/ destinationHex, addDrawnFleetToCanvas, /*int?*/ turnsToDestination, /*int?*/ totalTravelDistance) {

	this.DrawnFleet = new Astriarch.DrawnFleet(this);
	if(addDrawnFleetToCanvas)
	{
	...
	this.DrawnFleet.SetDestination(travelingFromHex, destinationHex, turnsToDestination, totalTravelDistance);
};
...
Astriarch.Fleet.prototype.MoveFleet = function() {
	...
	this.DrawnFleet.TurnsToDestination -= 1;
...
Astriarch.Fleet.prototype.LandFleet = function(/*Fleet*/ landingFleet, /*Hexagon*/ newLocation){
	...
	landingFleet.DrawnFleet.travelingFromHex = null;
	landingFleet.DrawnFleet.DestinationHex = null;
	landingFleet.DrawnFleet.TurnsToDestination = 0;
 ...
 * @constructor
 */
Astriarch.Fleet.LastKnownFleet = function(/*Fleet*/ fleet, /*Player*/ owner){
